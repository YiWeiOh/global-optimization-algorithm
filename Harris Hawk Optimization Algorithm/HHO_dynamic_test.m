...
while t<T
    ...
    for i=1:size(X,1)
        ...
        elseif abs(Escaping_Energy)<1
            ...
            if r<0.x5 && abs(Escaping_Energy)>=0.5, % Soft besiege % rabbit try to escape by many zigzag deceptive motions
    ...
    disp(['Iteration ' num2str(m) ': Best Cost = ' num2str(abs(Rabbit_Energy))]);
...
while t<R
    ...
    E1=2*(1-(t/R)); % factor to show the decreaing energy of rabbit
    % Update the location of Harris' hawks
    for i=1:size(X,1)
        E0=2*rand()-1; %-1<E0<1
        Escaping_Energy=E1*(E0);  % escaping energy of rabbit
...
while t<l
  for i=1:size(X,1)
    ...
    E1=2*(1-(t/l)); % factor to show the decreaing energy of rabbit
    % Update the location of Harris' hawks
    for i=1:size(X,1)
        E0=2*rand()-1; %-1<E0<1
        Escaping_Energy=E1*(E0);  % escaping energy of rabbit
...
while t<k
   for i=1:size(X,1)
    ...
    E1=2*(1-(t/k)); % factor to show the decreaing energy of rabbit
    % Update the location of Harris' hawks
    for i=1:size(X,1)
        E0=2*rand()-1; %-1<E0<1
        Escaping_Energy=E1*(E0);  % escaping energy of rabbit
